...
import com.mss.springboot.web.app.CRUD.global.dto.utils.Operations;
...
public class GlobalException {
	...
	public ResponseEntity<MessageDto> validationException(MethodArgumentNotValidException e){
		...
		return ResponseEntity.badRequest()
				.body(new MessageDto(HttpStatus.BAD_REQUEST, Operations.trimBrackeets(messages.toString())));
	}
